        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="modal fade" id="bukudetwebModal<?php echo $rowb['id_peminjaman']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel"> Detweb Laporan</h5>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Sampul</th>
                                                <th>:</th>
                                                <td><img src="../assets/img/<?php echo $rowb['gambar']; ?>" alt="" width="100px"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <th>Status</th>
                                                <th>:</th>
                                                <td><?php echo $rowb['status_peminjaman']; ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="Copyright text-center my-auto">
                        <span><b>Copyright ©2023-2024 SMKN 1 BANJAR -BANJAR.ALL rights reserved</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
